...
public class SsSegment {
    ...
    public String toString() {
        ...
        sb.append(SsSegment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("index");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SsSegment) == false) {
            return false;
        }
        SsSegment rhs = ((SsSegment) other);
