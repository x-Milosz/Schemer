...
public class GeneralTests {
    ...
    private static final File  file = new File("src/test/resources/testSourceJSONFiles/148d-assembly-1.json");
    ...
    public void parseMetadataTest() {
        try {
            MetadataContainer metadata = objectMapper.readValue(file, MetadataContainer.class);
